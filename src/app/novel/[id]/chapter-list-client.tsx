    ...
    <div className="divide-y divide-gray-50">
      {chapters.map((chapter) => (
        <Link
          ...
          className="px-6 py-3.5 flex items-center justify-between hover:bg-amber-50/50 transition-colors group"
        >
          ...
          <span className="text-xs text-gray-300">{chapter.word_count}字</span>
        </Link>
      ))}
    </div>
  )
