        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Suspense fallback={
            <div className="flex justify-center space-x-4">
              <span className="px-8 py-3 bg-gray-200 rounded-xl animate-pulse">加载中...</span>
              <span className="px-8 py-3 border-2 border-gray-200 rounded-xl animate-pulse">加载中...</span>
            </div>
          }>
            <HeroButtons />
          </Suspense>
